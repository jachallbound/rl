...
void set_volk_3d(double* array, double value, int i0, int i1, int i2, int len) {
  ...
  if (index_3d < len) array[index_3d] = value;
  else {
...
void set_volk_4d(double* array, double value, int i0, int i1, int i2, int i3, int len) {
  ...
  if (index_4d < len) array[index_4d] = value;
  else {
...
double get_volk_3d(double* array, int i0, int i1, int i2, int len) {
  // printf("i0 = %2d, i1 = %2d, i2 = %2d | \n", i0, i1, i2);
  int index_3d = i0*S1*S2 + i1*S2 + i2;
  if (index_3d < len) return array[index_3d];
  else {
    fprintf(stderr, "(3d) Attempted read beyond array length: %d > %d\n", index_3d, len);
    exit(1);
  }
  return 0;
}
...
double get_volk_4d(double* array, int i0, int i1, int i2, int i3, int len) {
  // printf("i0 = %2d, i1 = %2d, i2 = %2d i3 = %2d | \n", i0, i1, i2, i3);
  int index_4d = i0*S1*S2*A0 + i1*S2*A0 + i2*A0 + i3;
  if (index_4d < len) return array[index_4d];
  else {
    fprintf(stderr, "(4d) Attempted read beyond array length: %d > %d\n", index_4d, len);
    exit(1);
  }
  return 0;
}